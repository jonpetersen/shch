...
route1:
  anchor: route1
  heading: Route 1 (off road) - Hascombe Hill via Dunsfold and The Wey & Arun Canal (3 1/2 to 4 hours cycle time)
  description: >
...
route2:
  anchor: route2
  heading: Route 2 (off road) - Blackdown via Chiddingfold, Shillinglee and Upper Vann (4 to 5 hours cycle time)
  description: >
...
route3:
  anchor: route3
  heading: Route 3 (off road) - Devil's Punchbowl via Witley, Thursley and Hankley Commons, Chiddingfold, Dunsfold and Upper Vann (4 1/2 to 5 hours cycle time)
  description: >
...
route4:
  anchor: route4
  heading: Route 4 (off road) - Thursley Common via Bowlhead Green, Witley Common and Busses Common (3 to 3 1/2 hours cycle time)
  description: >
...
route5:
  anchor: route5
  heading: Route 5 (off road) - Hankley Common via Shackleford, Tilford, Thursley Common (5 to 6 hours cycle time)
  description: >
...
route6:
  anchor: route6
  heading: Route 6 (off road) - Loxwood via Loxhill, Dunsfold, Sidney Wood, Hog Wood, Tugely Wood (3 1/2 to 4 1/2 hours cycle time)
  description: >
...
route7:
  anchor: route7
  heading: Route 7 (off road) - Devil's Punchbowl Out & Back from Hambledon (3 1/2 to 4 hours cycle time)
  description: >
...
route8:
  anchor: route8
  heading: Route 8 (on road) - Box Hill via Coldharbour, Leith Hill (4 1/2 to 5 1/2 hours cycle time)
  description: >
